...
if __name__ == '__main__':
   ...
   print(df.groupby([df.date.dt.strftime("%Y-%m-%d")])['sentiment'].mean().reset_index(name='daily Average'))
   #print(df.groupby([df.date.dt.strftime("%Y-%m-%d")])['sentiment','likes'].mean())
   df.groupby([df.date.dt.strftime("%Y-%m-%d")])['sentiment'].mean().plot(kind='bar')
   plt.show()
